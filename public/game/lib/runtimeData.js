const runtimeData = (function () {
  return {
    ...
    // File references.
    buildURL: "bin",
    loaderURL: "bin/hexAway_Web_YandexGames.loader.js",
    dataURL: "bin/hexAway_Web_YandexGames.data.gz",
    frameworkURL: "bin/hexAway_Web_YandexGames.framework.js.gz",
    workerURL: "",
    codeURL: "bin/hexAway_Web_YandexGames.wasm.gz",
    symbolsURL: "",
    ...
    backgroundTextureName: "Background.png",
